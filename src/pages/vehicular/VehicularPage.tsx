...
const submodules = [
  { icon: Car, label: 'Catálogo Vehicular', description: 'Flotilla de vehículos registrados', path: '/vehicular/catalogo' },
  { icon: Route, label: 'Control de Viajes', description: 'Bitácora de viajes de la flotilla', path: '/vehicular/control-viajes' },
];
